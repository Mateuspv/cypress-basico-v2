...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function() {
        ...
        cy.get('#email').type('Mateuspv2003@gmail.com')
    ...
    it('verefica o valor de campo numerico', function() {

    cy.get('#phone').type('abcdefh').should('have.value', '')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName').type('veroneze').should('have.value', 'veroneze').clear().should('have.value', '')
        cy.get('#email').type('Mateuspv2003@gmail.com').should('have.value', 'Mateuspv2003@gmail.com').clear().should('have.value', '')
